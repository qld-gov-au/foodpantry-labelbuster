  ...
  <section class="qg-accordion flex-column" aria-label="Accordion Label">
    ...
    <article>
      ...
      >
        ...
        <ul>
          <li>cochineal may be listed as Colour (cochineal) or Colour (120)</li>
          <li>
        ...
        <p>
          ...
          claims that are not covered by Label Buster. We recommend you seek
          professional advice from a food labelling consultant to prepare your
          food label.
        </p>
        <section>
          <h4>Further reading</h4>
  ...
  <section class="qg-accordion flex-column" aria-label="Accordion Label">
    ...
    <article>
      ...
      >
        <p>
          <b
            >If the cereal is wheat, rye, barley, oats or spelt or a hybridised
            strain of one of those cereals:
          </b>
          <br />
        ...
        <p>
          ...
          >
          <br />
          The name ‘starch’ may be used for any unmodified starch or any starch
          which has been modified by either physical means or enzymes.
        </p>
        <section>
          <h4>Further reading</h4>
          <p>
    ...
    <article>
      ...
      >
        ...
        <p>
          Note: This does not apply for isinglass derived from swim bladders and
    ...
    <article>
      ...
      >
        <p>
          <b>
            The generic name of milk solid may be used to describe an ingredient
            that is:
          </b>
        </p>
        <ul>
    ...
    <article>
      ...
      >
        <p>
          ...
          <br />
          For example: Almonds, cashews, brazil nuts, hazelnuts, macadamia nuts,
          peanuts, pecans, pine nuts, walnuts
        </p>
        <section>
          <h4>Further reading</h4>
          <p>
    ...
    <article>
      ...
      >
        ...
        <ul>
          ...
          <li>
            if the source of oil is lupin, peanut or sesame—the specific source
            name
          </li>
          <li>
            if the source of oil is soybeans and the oil has not been degummed,
            neutralised, bleached and deodorised—the specific source name
          </li>
          <li>
      ...
      >
        <p>
          <b
            ...
            area of less than 100 cm2:</b
          >
          <br />
          The ingredient list is not required is not required for food in small
          packages.
          <br />
