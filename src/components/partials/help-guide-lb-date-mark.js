...
export default () => html`<div class="side-padding vertical-padding">
    ...
    <section class="qg-accordion flex-column" aria-label="Accordion Label">
        <div class="controls-group">
            ...
            <label for="expand" class="controls" @click=${e => modifyAccordionState(e, true)}>
                Expand all
            </label>
            ...
            <label for="collapse" class="controls" @click=${e => modifyAccordionState(e, false)}>
                Collapse all
            </label>
        </div>

        <article>
            <input id="what-date-mark" type="checkbox" name="tabs" tabindex="-1" aria-controls="id-panel-content-1"
            ...
            <div class="collapsing-section" aria-hidden="true" id="id-panel-content-1">
                <p>
                    A date mark is a guide to how long a food will last. All packaged food with a shelf life of two years 
                    or less must show a date mark, except for individual portions of ice cream or ice confection.
                </p>
                <p>
                    <a href="#">
                        Shelf life
                ...
                <ul>
                    ...
                    <li>
                        looks, smells and tastes ok, and
                    </li>
                    <li>
                ...
                <p>
                    ...
                    <a href="#best-before-date">
                        best-before date
                    </a>
                    , but may not look, smell or taste the same as when it was
                    fresh. Bread with a shelf life of less than 7 days, can be date marked with a 
                    <a href="#baked-for-on-date">
                        baked-on or baked-for date.
                    </a>
                </p>

                <p>
                    It may be necessary to seek expert advice from a food testing laboratory:
                </p>
                <ul>
                    <li>
                        to determine your food’s shelf life
                    </li>
                    <li>
                ...
                <p>
                    ...
                    (how it appears on label). The day and month are
                    required for a food with a shelf life of 3 months or less, whereas the month and year are required for a food with a
                    longer shelf life.
                </p>
                <section>
        ...
        <article>
            <input id="baked-for-on-date" type="checkbox" name="tabs" tabindex="-1" aria-controls="id-panel-content-1"
                aria-expanded="false" role="checkbox" />
            <button class="acc-heading">
                <label for="baked-for-on-date">
                    <span class="title">
                        Baked-on and baked-for dates
                    </span>
                    <span class="arrow"><i></i></span>
                </label>
            </button>
            <div class="collapsing-section" aria-hidden="true" id="id-panel-content-1">
                ...
                <p>
                    The baked-on date means the date on which the bread was baked.
                </p>
                The baked-for date means:
                <ul>
                    <li>If the time at which the bread was baked is before midday – the baked-on date</li>
                    <li>If the time at which the bread was baked is after midday – the day after the baked-on date. Bread that is baked after
                    midday on one day may have a baked-for date of the following day. The baked-for date must not be later than 12 hours
                    after the time the bread was baked.</li>
                </ul>
                <p>
        ...
        <article>
            <input id="best-before-date" type="checkbox" name="tabs" tabindex="-1" aria-controls="id-panel-content-1"
                aria-expanded="false" role="checkbox" />
            <button class="acc-heading">
            ...
            <div class="collapsing-section" aria-hidden="true" id="id-panel-content-1">
                ...
                <p>
                The words ‘Best Before’ must be included on the label followed by the date, or a direction provided about where the date
                is located. For example:
                </p>
                <ul>
                    <li>
                        Best Before 23 Dec 2021
                    </li>
                    <li>
                ...
                <p>
                    Foods may be sold after the best-before date if the food has not spoiled and complies with any other applicable
                    legislation.
                </p>
                <section>
                    <h4>Further reading</h4>
        ...
        <article>
            <input id="date-format" type="checkbox" name="tabs" tabindex="-1" aria-controls="id-panel-content-1"
                aria-expanded="false" role="checkbox" />
            <button class="acc-heading">
            ...
            <div class="collapsing-section" aria-hidden="true" id="id-panel-content-1">
                <p>
                    The day, month and year must be written so that it is clear which number refers to the day, the month or the year.
                </p>
                <p>
                    The month can be expressed in either:
                <ul>
                    <li>
                        numerical form, e.g. 01 for January; or
                    </li>
                    <li>
                ...
                <p>
                    The year can be expressed in numerical form using either:
                    <ul>
                        <li>
                            2 digits, e.g. 21; or
                        </li>
                ...
                <p>
                    The date format depends on the shelf life of the food. The day and month (e.g. 15/03/2020) are required for a food with
        ...
        <article>
            <input id="lot-identification" type="checkbox" name="tabs" tabindex="-1" aria-controls="id-panel-content-1"
                aria-expanded="false" role="checkbox" />
            <button class="acc-heading">
            ...
            <div class="collapsing-section" aria-hidden="true" id="id-panel-content-1">
                <p>
                    ...
                    packed and the batch the food is part of. It is not necessary to include lot identification on a label because the date
                    mark, business name and address can be used instead. Additional information that is part of a system devised by the
        ...
        <article>
            <input id="use-by-date" type="checkbox" name="tabs" tabindex="-1" aria-controls="id-panel-content-1"
                aria-expanded="false" role="checkbox" />
            <button class="acc-heading">
            ...
            <div class="collapsing-section" aria-hidden="true" id="id-panel-content-1">
                <p>
                    The use-by date is the date after which the food should not be eaten because it is no longer safe, provided it has been
                    stored according to any stated storage conditions on the label and the package is unopened.
                </p>
                <p>
                    For example, milk is usually labelled with a use-by date because it may become unsafe before it becomes rancid, bitter,
                    or separates.
                </p>
                <p>
                    You will need to determine the shelf life of your food to work out how long it can be safely stored. It is recommended
                    you seek professional advice from a food testing laboratory.
                </p>
                <p>
                    The words ‘Use By’ must be included on the label followed by the date. For example, Use By 23 Dec 2021.
                </p>
                <p>
...
<div class="side-padding vertical-padding">
    ...
    <section class="qg-accordion flex-column" aria-label="Accordion Label">
        ...
        <article>
            ...
            <div class="collapsing-section" aria-hidden="true" id="id-panel-content-1">
                <p>
                    If the food sold in a small package where the package has a surface area of less than 100 cm2 only a use-by date needs
