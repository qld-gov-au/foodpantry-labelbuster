      ...
      >
        ...
        <ul>
          <li>
            ...
            Information requirements – characterising ingredients and components
            of food.
          </li>
        </ul>
    ...
    <article>
      ...
      >
        <p>
          ...
          fruit. A jam can include conserve but it does not include marmalade.
        </p>
        <h4>Further reading</h4>
        <p>
          <i>Australia New Zealand Food Standards Code</i>
    ...
    <article>
      ...
      >
        ...
        <p>
          ...
          Non-alcoholic drinks and brewed soft drinks (eg fermented ginger beer
          or kombucha) must not suggest the product is an alcoholic beverage.
        </p>
        <p>
