...
<div class="side-padding vertical-padding">
  ...
  <p>
    Click on hyperlinks in Label Buster to open the help guide for a topic that
    applies to all food.
  </p>
  ...
  <p>
    ...
    apply to your food or its ingredients to learn more about these extra rules.
  </p>
